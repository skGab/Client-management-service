...
export class ContractRepositoryService implements ContractRepository {
  ...
  async getExpiring(): Promise<RepositoryResponse<ExpiringContractVo[]>> {
    try {
      ...
      // RETURN THE VO
      return new RepositoryResponse<ExpiringContractVo[]>(expiringContractVo);
    } catch (error) {
  ...
  async getContractById(id: {
    ...
    try {
      ...
      return new RepositoryResponse<ContractEntity>(contractEntity);
    } catch (error) {
      this.logger.error(error);
      throw error;
    }
  ...
  async create(
    ...
    try {
      ...
      return new RepositoryResponse<string>('Novo Contrato Registrado');
    } catch (error) {
      this.logger.error(error);
      throw error;
    }
