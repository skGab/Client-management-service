...
export class ClientFactoryService {
  public toClientCnpjEntity(clientCnpj, contracts): ClientCnpjEntity {
    return new ClientCnpjEntity(
      {
        ...
        estado_civil_segundo_contato: clientCnpj.estado_civil_segundo_contato,
        ...
        estado_civil_terceiro_contato: clientCnpj.estado_civil_terceiro_contato,
  ...
  public toContractEntity(contract): ContractEntity {
